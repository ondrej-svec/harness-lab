...
- [ ] **D1. Review pass: agenda.json scenes batch 1.** ~9 scenes from the opening + talk + demo phases that didn't get scene-card treatment in `2026-04-13-czech-mode-a-scene-cards.md`. Subagent reads the EN canonical and the CS in agenda.json side-by-side; reports drift, calque-y phrasing, register issues, vocabulary mismatches, voice mismatches. Output: review memo at `docs/reviews/workshop-content/2026-04-13-czech-batch-1-opening-talk-demo.md`. Then pause.
- [ ] **D2. Ondrej signoff D1.** Read the memo. Apply selective fixes. Flip `cs_reviewed: true` on scenes that pass.
- [ ] **D3. Review pass: agenda.json scenes batch 2.** ~9 scenes from build-1 + intermezzo-1 + lunch-reset + rotation phases. Same process. Memo at `docs/reviews/workshop-content/2026-04-13-czech-batch-2-build-rotation.md`.
- [ ] **D4. Ondrej signoff D2.**
- [ ] **D5. Review pass: agenda.json scenes batch 3.** ~9 scenes from build-2 + intermezzo-2 + build-2-second-push + reveal phases. Memo at `docs/reviews/workshop-content/2026-04-13-czech-batch-3-reveal.md`.
- [ ] **D6. Ondrej signoff D3.**
- [ ] **D7. Review pass: talks (CS).** `content/talks/context-is-king.md` (already partially reviewed today) + `content/talks/codex-demo-script.md`. Memo at `docs/reviews/workshop-content/2026-04-13-czech-talks.md`.
- [ ] **D8. Ondrej signoff D7.**
- [ ] **D9. Review pass: project briefs (CS).** All 5 brief CS files. They got recent ty→vy treatment in `d7b9000` but no full prose review. Memo at `docs/reviews/workshop-content/2026-04-13-czech-briefs.md`.
- [ ] **D10. Ondrej signoff D9.**
- [ ] **D11. Review pass: materials (CS).** `materials/participant-resource-kit.md` (CS — partially reviewed today) + the new `coaching-codex.md` CS translation (from B6). Memo at `docs/reviews/workshop-content/2026-04-13-czech-materials.md`.
- [ ] **D12. Ondrej signoff D11.**
- [ ] **D13. Review pass: facilitation (CS).** `master-guide.md` (CS) + `codex-setup-verification.md` (CS). Memo at `docs/reviews/workshop-content/2026-04-13-czech-facilitation.md`.
- [ ] **D14. Ondrej signoff D13.**
- [ ] **D15. Review pass: challenge cards (CS).** `deck.md` + `print-spec.md`. Memo at `docs/reviews/workshop-content/2026-04-13-czech-cards.md`.
- [ ] **D16. Ondrej signoff D15.**
