...
test("facilitator skill routes privileged operations through the harness CLI without becoming a secret store", async () => {
  ...
  assert.match(skillText, /harness instance list/);
  assert.match(skillText, /harness instance show/);
  assert.match(skillText, /harness instance create/);
  assert.match(skillText, /harness instance update/);
  assert.match(skillText, /harness instance reset/);
  assert.match(skillText, /harness workshop prepare/);
  assert.match(skillText, /harness instance remove/);
