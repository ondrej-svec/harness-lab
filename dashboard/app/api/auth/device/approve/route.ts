...
import { approveDeviceAuthorizationForCurrentSession } from "@/lib/facilitator-cli-auth-repository";
...
export async function POST(request: Request) {
  ...
  const result = await approveDeviceAuthorizationForCurrentSession(body.userCode);
