...
function getParticipantSurfaceCopy(lang: UiLanguage) {
  if (lang === "en") {
    return {
      ...
      referenceBody: "This is the main reference shelf: workshop materials first, then setup and plugins, then the external reads.",
  ...
  return {
    ...
    referenceBody: "Tady je hlavní police s podklady: nejdřív workshopové materiály, potom setup a pluginy a nakonec externí čtení.",
