...
export const adminPanelSurfaceClassName =
  "relative overflow-hidden rounded-[28px] border border-[var(--border)] bg-[linear-gradient(180deg,var(--card-top),var(--card-bottom))] shadow-[var(--shadow-soft)] backdrop-blur transition duration-200 hover:-translate-y-0.5 hover:shadow-[0_24px_50px_rgba(28,25,23,0.1)]";
...
export function SummaryStat({
  ...
  return (
    <div className="bg-[linear-gradient(180deg,var(--card-strong-top),var(--card-strong-bottom))] px-4 py-4 transition-colors duration-200 sm:px-6 sm:py-5">
