...
export const workshopMeta = {
  ...
  adminHint: "Admin panel je zatím seedovaný lokálními daty. Databázi lze doplnit bez změny API kontraktu.",
};
...
export const rotation: RotationPlan = {
  revealed: false,
...
export const monitoring: MonitoringSnapshot[] = [
...
export const sprintUpdates: SprintUpdate[] = [
  {
    id: "u1",
    teamId: "t1",
